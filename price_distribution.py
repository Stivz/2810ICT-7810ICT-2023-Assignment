...
class PriceDistribution(wx.Frame):
	def __init__( self, parent, main_frame ):
		...
		self.m_staticText7.SetFont( wx.Font( 30, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, wx.EmptyString ) )
		bSizer15.Add( self.m_staticText7, 0, wx.ALIGN_CENTER|wx.ALL, 5 )

		self.m_staticText2 = wx.StaticText( self, wx.ID_ANY, u"Price Dristribution Chart", wx.DefaultPosition, wx.DefaultSize, 0 )
